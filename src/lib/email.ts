    ...
    <table width="100%" cellpadding="0" cellspacing="0"
      ...
      <tr>
        <td style="padding:24px;">
          ...
          <p style="margin:0 0 10px;font-size:14px;color:#FFF8EE;">1 &nbsp;Landlord receives your booking request</p>
          <p style="margin:0 0 10px;font-size:14px;color:#FFF8EE;">2 &nbsp;They confirm within 48 hours</p>
          <p style="margin:0 0 10px;font-size:14px;color:#FFF8EE;">3 &nbsp;You receive their contact details by email</p>
          <p style="margin:0;font-size:14px;color:#FFF8EE;">4 &nbsp;Schedule your viewing and arrange the contract</p>
        </td>
      </tr>
    </table>
      ...
      <tr>
        <td style="padding:20px 24px;">
          <p style="margin:0;font-size:14px;color:#FFF8EE;line-height:1.6;">
             <strong style="color:#2ECC71;">Full refund guarantee:</strong> If the landlord doesn't confirm within 48 hours, you'll receive a full automatic refund of €50 — no questions asked.
          </p>
        </td>
      </tr>
    </table>
    ...
    <table width="100%" cellpadding="0" cellspacing="0"
      ...
      <tr>
        <td style="padding:24px;">
          ...
          ${params.guestEmail ?`<p style="margin:0 0 6px;font-size:14px;color:#B8A090;"> &nbsp;${params.guestEmail}</p>` :''}
      ...
      <tr>
        <td style="padding:16px 20px;">
          <p style="margin:0;font-size:13px;color:#B8A090;line-height:1.6;">
             If you do not respond within 48 hours, the booking will be automatically cancelled and the student will receive a full refund.
          </p>
        </td>
      </tr>
    </table>
  ...
  const content =`
    ...
    <table width="100%" cellpadding="0" cellspacing="0"
      ...
      <tr>
        <td style="padding:24px;">
          ...
          ${params.partnerEmail ?`<p style="margin:0 0 8px;font-size:15px;color:#FFF8EE;"> &nbsp;Email: <a href="mailto:${params.partnerEmail}" style="color:#FF6B00;font-weight:600;">${params.partnerEmail}</a></p>` :''}
    ...
    <table width="100%" cellpadding="0" cellspacing="0"
      ...
      <tr>
        <td style="padding:24px;">
          ...
          <p style="margin:0 0 10px;font-size:14px;color:#FFF8EE;">1 &nbsp;Contact the landlord on WhatsApp or email</p>
          <p style="margin:0 0 10px;font-size:14px;color:#FFF8EE;">2 &nbsp;Schedule a viewing at a convenient time</p>
          <p style="margin:0 0 10px;font-size:14px;color:#FFF8EE;">3 &nbsp;Sign the rental contract</p>
          <p style="margin:0;font-size:14px;color:#FFF8EE;">4 &nbsp;Pay rent + deposit directly to the landlord</p>
        </td>
      </tr>
    </table>
    ...
    <table width="100%" cellpadding="0" cellspacing="0"
      ...
      <tr>
        <td style="padding:16px 20px;">
          <p style="margin:0;font-size:13px;color:#B8A090;line-height:1.6;">
            ℹ <strong style="color:#FFF8EE;">Please note:</strong> Monthly rent and deposit are paid <strong style="color:#FFF8EE;">directly to the landlord</strong>, not through Erasmus Life. The €50 booking fee covers our platform service only.
          </p>
        </td>
      </tr>
    </table>
    ...
    <table width="100%" cellpadding="0" cellspacing="0"
      ...
      <tr>
        <td style="padding:24px;">
          ...
          ${params.guestEmail ?`<p style="margin:0 0 8px;font-size:14px;color:#B8A090;"> &nbsp;${params.guestEmail}</p>` :''}
      ...
      <tr>
        <td align="center" style="padding:24px;">
          <p style="margin:0 0 16px;font-size:11px;text-transform:uppercase;letter-spacing:0.12em;color:#FF6B00;font-weight:700;">
            ${isTrip ?' Traveller' :'Ticket'} ${i + 1}${i === 0 ?' — You' :''}: ${t.name}
          </p>
...
`
  ...
  try {
    const { error } = await getResend().emails.send({
      ...
      to: params.to,
      subject: isTrip
        ?` ${n} trip spot${n > 1 ?'s' :''} — ${params.eventTitle}`
        : params.isFree
          ?` ${n} free ticket${n > 1 ?'s' :''} — ${params.eventTitle}`
          :` ${n} ticket${n > 1 ?'s' :''} — ${params.eventTitle}`,
      html,
      attachments,
    })
