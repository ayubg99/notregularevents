export function emailLayout(content: string, baseUrl: string, footerNote?: string): string {
  const footer = footerNote ??
    `Erasmus Vibe Valencia — your international community<br />Questions? Reply to this email or visit <a href="${baseUrl}" style="color:#FF6B00;">${baseUrl.replace('https://','')}</a>`
