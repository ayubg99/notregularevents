...
export async function POST() {
  ...
  const jobs: JobRow[] = [
    ...
    },
    {
      ...
      company_name:      'Nomad Coliving Valencia',
      description:       'We run a coliving space for digital nomads and international students in Ruzafa. Looking for an outgoing community manager to organise weekly events, welcome new residents, manage our social media and make our community the best in Valencia. Free breakfast every morning included.',
