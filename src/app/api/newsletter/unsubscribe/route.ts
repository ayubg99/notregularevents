...
<body style="margin:0;padding:0;background:#1A1209;font-family:Inter,Arial,sans-serif;color:#FFF8EE;display:flex;align-items:center;justify-content:center;min-height:100vh;">
  <div style="max-width:480px;margin:0 auto;padding:40px 24px;text-align:center;">
    ...
    <a href="${baseUrl}" style="display:inline-block;background:#F5A623;color:#1A1209;font-weight:700;font-size:14px;text-decoration:none;padding:12px 28px;border-radius:9999px;">
