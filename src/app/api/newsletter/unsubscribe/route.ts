...
export async function GET(req: NextRequest) {
  ...
  if (error) {
    ...
    return new Response(unsubscribePage('Something went wrong', 'Please try again or contact us at notregularevents@gmail.com.'), {
      status: 500,
      headers: { 'Content-Type': 'text/html' },
    })
  }

  return new Response(unsubscribePage('Unsubscribed', "You've been removed from the Not Regular Events newsletter. No more emails from us!"), {
    status: 200,
    headers: { 'Content-Type': 'text/html' },
  })
}
...
<body style="margin:0;padding:0;background:#0D0D0D;font-family:'JetBrains Mono',Arial,monospace;color:#FFF8EE;display:flex;align-items:center;justify-content:center;min-height:100vh;">
  <div style="max-width:480px;margin:0 auto;padding:40px 24px;text-align:center;">
    <img src="${baseUrl}/nre-logo.png" alt="Not Regular Events" height="48" style="display:block;margin:0 auto 32px;" />
