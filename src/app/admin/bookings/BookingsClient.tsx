              ...
              <div>
                ...
                <div className="flex flex-col gap-1.5">
                  {booking.selected_extras.map(extra => (
                    <div key={extra.id} className="flex items-center justify-between px-3 py-2 rounded-lg bg-white/5 border border-white/10">
                      <div>
                      ...
                      <span className="font-mono text-sm font-semibold text-white/60 ml-3 shrink-0">
