    ...
    <main className="container-clean min-h-screen bg-brand-dark flex items-center justify-center py-20 pt-28 md:pt-20">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-heading text-3xl font-bold text-white mb-2">Join Not Regular Events</h1>
          <p className="text-white/50 text-sm">Create your free account and never miss an event</p>
        </div>
