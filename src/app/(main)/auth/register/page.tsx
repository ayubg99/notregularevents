      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-1 mb-6 group">
            <span className="font-heading text-2xl font-bold text-white tracking-tight">Erasmus Vibe</span>
          ...
          <p className="text-white/50 text-sm">Join thousands of Erasmus students in Valencia</p>
        </div>
